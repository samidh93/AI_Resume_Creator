import unittest
import asyncio
from ..python.linkedin_job_description import LinkedinJobDescription
...
class TestJobDescriptionExtraction(unittest.TestCase):
    ...
    def test_extract_job_description(self):
        ...
        job_description = asyncio.run(self.job_description_extractor.get_text_job_description_with_pyppeteer())
    ...
    def test_invalid_url(self):
        ...
        job_description = asyncio.run(invalid_extractor.get_text_job_description_with_pyppeteer())
